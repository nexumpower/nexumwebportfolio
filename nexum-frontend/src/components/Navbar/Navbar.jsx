      ...
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
        ...
        <div className="md:hidden">
          <button
            ...
            className="relative w-10 h-10 bg-white/10 backdrop-blur-sm rounded-sm border border-white/20 text-white focus:outline-none focus:ring-2 focus:ring-green-400 transition-all duration-300 hover:bg-white/20 flex items-center justify-center"
          >
            <div className="relative">
              {isOpen ? (
